...
function LogMethod(target, propertyKey, descriptor) {
    ...
    descriptor.value = function () {
        ...
        console.log("Method ".concat(propertyKey, " is called with arguments: ").concat(args));
...
var Myclass = function () {
    ...
    var Myclass = _classThis = /** @class */ (function () {
        function Myclass_1(name) {
            this.name = __runInitializers(this, _instanceExtraInitializers);
            this.name = name;
        }
        Myclass_1.prototype.greet = function (greeting) {
...
var obj = new Myclass("Jayesh");
console.log(obj.greet("Hello"));
function ReplaceWithProxy(constructor) {
    return /** @class */ (function (_super) {
        __extends(class_1, _super);
        function class_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.proxyEnabled = true;
            return _this;
        }
        return class_1;
    }(constructor));
...
var Order = function () {
    var _classDecorators = [ReplaceWithProxy];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var Order = _classThis = /** @class */ (function () {
        function Order_1(id, amount) {
            this.id = id;
            this.amount = amount;
        }
        return Order_1;
